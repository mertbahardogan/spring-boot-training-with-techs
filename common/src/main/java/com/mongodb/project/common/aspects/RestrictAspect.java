package com.mongodb.project.common.aspects;

import com.mongodb.project.common.exceptions.ForbiddenException;
...
public class RestrictAspect {
    @Before("@annotation(com.mongodb.project.common.aspects.Restrict) && execution(public * *(..))")
